<?php
    ...
    /**
     * UCash Mobile Banking Payment Gateway
     *
    ...
    class WC_Gateway_UCash extends WC_Payment_Gateway {
        ...
        public function __construct() {
            $this->id                 = 'UCash';
            $this->icon               = apply_filters('woocommerce_dbblmb_icon', plugins_url( '/images/UCash.png', __FILE__ ));
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                                       'enabled' => array(
                                                          ...
                                                          'type'    => 'checkbox',
                                                          'label'   => __( 'Enable UCash Mobile Banking', 'woocommerce' ),
                                                          'default' => 'yes'
                                                          ),
                                       'title' => array(
                                                        ...
                                                        'default'     => __( 'UCash Mobile Banking', 'woocommerce' ),
                                                        'desc_tip'    => true,
                                                        ),
                               'description' => array(
...
<?php
    ...
    private function UCash_details( $order_id = '' ) {
        ...
        echo '<h2>' . __( 'Our UCash Mobile Banking Details', 'woocommerce' ) . '</h2>' . PHP_EOL;
